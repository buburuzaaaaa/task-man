...
const people = [
  { id: 1, name: "john", description: "Get grocerys" },
  { id: 2, name: "peter", description: "Clean" },
  { id: 3, name: "susan", description: "Go to the Gym" },
  { id: 4, name: "anna", description: "Nothing" },
  { id: 5, name: "emma", description: "Go to work" },
];
